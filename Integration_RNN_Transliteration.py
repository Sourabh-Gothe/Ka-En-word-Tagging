...
def GetTestData(Sentence):
    ...
    #print(vocab)
    voc_vec = word2vec.Word2Vec(vocab,min_count=1,size=MAX_WORD_LENGTH,seed=1)
    X =[]
...
model.fit(X_train, trainY,n_epoch=100,shuffle=True,validation_set=(X_test, testY),  show_metric=True,
      batch_size=100)
